...
维护范围：`D:\CodexWorkspace` 的目录架构、项目放置规则和命名规则。
...
```text
D:\CodexWorkspace\projects\Project_001_项目名称
```
...
无论从哪里打开外部项目，都必须先迁移或复制到 `D:\CodexWorkspace` 后再继续工作。
...
- 迁移完成后，只操作 `D:\CodexWorkspace` 内的副本。
...
迁移后：D:\CodexWorkspace\projects\Project_007_我的应用
```
